    ...
    <div class="container-fluid mt-4 " id="create-form">
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://media.istockphoto.com/photos/youre-the-best-teacher-picture-id1292825155?s=612x612" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="cne" type="text" class="form-control"  placeholder="Enter admission number">
                            </div>
                            <div class="form-group">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$student->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>Admission Number</label>
                                <input value="{{ $student->cne }}" name="cne" type="text" class="form-control"  placeholder="Enter Admission Number">
                            </div>
                            <div class="form-group">
                                <label>First Name</label>
